            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/ACrepair.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="acrepairing.jsp">AC Repairing</a></h2>
                                <p>Let our experienced technicians handle your AC repair needs. We offer affordable air conditioning
                                repairing service. <!-- We offer a service whereby we personally contact you with a reminder when your air conditioning
                                system is due for servicing and filter replacements. --> Our Service 
                                partners are committed to achieving excellence and can repair major brands.</p>
                                <a href="acrepairing.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                   <!--  <div class="service-box-layout4">
                    ...
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/Fanrepair.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="fanrepairing.jsp">Fan Repairing</a></h2>
                                <p>We try to satisfy our clients by rendering Telecom Fans Repairing Service. These services entail the utilization of modern repairing tools, progressive equipment and advanced machines. Our skilled professionals provide full-fledged solutions that include repairing and servicing of fans. 
                                </p>
                                <a href="fanrepairing.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/ACservicing.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="acservicing.jsp">AC Servicing</a></h2>
                                <p>  We offer affordable air conditioning service in ahmedabad we offer a service whereby we personally contact you with a reminder when your air conditioning system is due for servicing and filter replacements. Extend your AC life by booking AC maintenance services at affordable rates.</p>
                                <a href="acservicing.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>

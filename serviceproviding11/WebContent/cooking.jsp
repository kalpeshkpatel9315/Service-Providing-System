...
<!-- Mirrored from radiustheme.com/demo/html/fixer/fixer/single-service3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jan 2020 06:36:28 GMT -->
                    ...
                    <div class="col-12">
                        <div class="breadcrumbs-area">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="servicesdetails.jsp">Services</a>
                                </li>
                                <li>Details</li>
                            </ul>
                        </div>
                ...
                <div class="row">
                   <div class="col-lg-8 order-lg-2">
                        <div class="single-service-box-layout1">
                            ...
                            <div class="item-content">
                                <h2 class="item-title">${user1.serv_subname }</h2>
                   ...
                   <div class="col-lg-4 sidebar-break-md sidebar-widget-area order-lg-1">
                        <div class="widget widget-service-info">
                            ...
                            <div class="item-price">${user1.price}</div>
                            <a href="ServicesDetailsController?action=placeorder&serv_det_id=${user1.serv_det_id }" class="item-btn">Place Order<i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
...
<!-- Mirrored from radiustheme.com/demo/html/fixer/fixer/single-service3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jan 2020 06:36:32 GMT -->
</html>
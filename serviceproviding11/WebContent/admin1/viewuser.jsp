                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Customer</h2>
                                        ...
                                        <table id="example" class="display table table-hover table-condensed">
                                          ...
                                          <s:forEach var="user1" items="${user1}">
                                                <tr>
                                                    ...
                                                    <td>${user1.p_no }</td>
                                                    <td>${user1.address }</td>
                                                    <td><a href="ViewUser?action=deletedata&uid=${user1.uid}">Delete</a></td>
                                                    <td><a href="ViewUser?action=updatedata&uid=${user1.uid}">Update</a></td>

...
<body class=" ">
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">UPDATE SERVICE PROVIDER</h1>                            
                            </div>
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>UPDATE SERVICE PROVIDER</strong>
                                    </li>
                                </ol>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Edit Serviceprovider Account Info</h2>
 ...
 -->
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-2">Area of Interest</label>
                                                <!-- <span class="desc"></span> -->
    ...
    <%
			...
			%>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-2">A/C No</label>
                                                <span class="desc"></span>
                                                    <input type="text" value="${user1.a_no }" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="a_no">
                                                <div class="controls">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-2">A_Img</label>
                                                <span class="desc"></span>
                                                    <input type="file" value="${user1.a_img }" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="a_img">
                                                <div class="controls">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-2">S_Img</label>
                                                <span class="desc"></span>
                                                    <input type="file" value="${user1.s_img }" class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="s_img">
                                                <div class="controls">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                                <button type="submit" value="updateserviceprovider" name="action" class="btn btn-primary">UPDATE</button>

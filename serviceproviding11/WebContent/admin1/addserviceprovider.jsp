    ...
    <%
			...
			%>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                    <input type="text" class="form-control" id="field-2"  name="a_no">
                                                <div class="controls">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                    <input type="file"  class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="a_img">
                                                <div class="controls">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                    <input type="file"  class="form-control" id="field-2" data-mask="phone"  placeholder="(999) 999-9999" name="s_img">
                                                <div class="controls">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                                <button type="submit" class="btn btn-primary" name="action" value="addserviceprovider">Save</button>

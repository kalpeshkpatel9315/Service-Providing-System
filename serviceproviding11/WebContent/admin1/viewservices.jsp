                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Services</h1>                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed">
                                          ...
                                          <s:forEach var="user1" items="${user1}">
                                                <tr>
                                                	 <td>${user1.serv_id}</td> 
                                                    <td>${user1.serv_name }</td>
                                                    <td>${user1.image}</td>
                                                    <td><a href="ServicesController?action=update&serv_id=${user1.serv_id}">Update</a></td>
                                                    <td><a href="ServicesController?action=delete&serv_id=${user1.serv_id}">Delete</a></td>

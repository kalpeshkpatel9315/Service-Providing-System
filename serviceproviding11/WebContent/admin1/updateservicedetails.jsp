...
<title>UPDATE SERVICE SUBCATEGORY</title>
...
<%@ include file="sidebar.jsp" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Update Service Subcategory</h2>
                            ...
                            <div class="content-body">
                                <div class="row">
                                ${msg }
                                    <form action ="ServicesDetailsController" method="post">
 ...
 --%>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${editservicedetail.serv_subname }" class="form-control" id="field-1" name="serv_subname">
                                                    <input type="hidden" value="${editservicedetail.serv_det_id }" class="form-control" id="field-1" name="serv_det_id">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="${editservicedetail.serv_detail }"  class="form-control" id="field-3" name="serv_detail">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="${editservicedetail.price }" class="form-control" id="field-4" name="price">
                                                </div>
                                            </div>
											  <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="file" value="${editservicedetail.serv_img }" class="form-control" id="field-5" name="serv_img">
                                                </div>
                                            </div>

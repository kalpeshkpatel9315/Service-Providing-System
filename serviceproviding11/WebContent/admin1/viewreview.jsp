                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">View Review</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Review</h2>
                                        ...
                                        <table id="example" class="display table table-hover table-condensed">
                                          ...
                                          <s:forEach var="vr" items="${vr}">
                                                <tr>
                                                    ...
                                                    <td><a href="Reviewcontroller?action=delete&rid=${vr.rid}">Delete</a></td>

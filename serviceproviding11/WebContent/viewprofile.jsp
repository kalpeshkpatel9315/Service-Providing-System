                        ...
                        <!-- <div class="media media-none--md"> -->
                            ...
                            <form action="LoginController">
                              <button type="submit" name="action" value="logout" style="margin-left:1090px;">LOGOUT</button>
                               ...
                               <div class="c1">
  <s:if test="${editp.uid > 0 }">
  <h1>View Profile</h1>
  <form action="ViewUser">
    <label for="fname">First Name</label>
    <input type="hidden" id="fname" name="u_id" value="${editp.uid}" >
    <input type="text" id="fname" name="f_name" value="${editp.f_name}" readonly>

    <label for="lname">Last Name</label>
    <input type="text" id="lname" name="l_name" value="${editp.l_name}" readonly>

    <label for="lname">Phone No</label>
    <input type="text" id="p_no" name="p_no" value="${editp.p_no}" readonly>
    
    <label for="subject">E_mail</label>
    <input type="text" id="e_mail" name="e_mail" value="${editp.e_mail}" readonly>

    <label for="subject">Address</label>
     <textarea id="subject" name="address"  style="height:50px" readonly>${editp.address}</textarea>

    
    
    <button type="submit" value="editprofile" name="action">Edit</button>
  </form>
  </s:if>
  <s:if test="${editp1.uid > 0 }">
  <h1>Edit Profile</h1>
   <form action="ViewUser" method="post">
   <label for="fname">First Name</label>
    <input type="hidden" id="fname" name="u_id" value="${editp1.uid}" >
    <input type="text" id="fname" name="f_name" value="${editp1.f_name}">

    <label for="lname">Last Name</label>
    <input type="text" id="lname" name="l_name" value="${editp1.l_name}" >

    <label for="lname">Phone No</label>
    <input type="text" id="p_no" name="p_no" value="${editp1.p_no}" >
    
    <label for="subject">E_mail</label>
    <input type="text" id="e_mail" name="e_mail" value="${editp1.e_mail}" >

    <label for="subject">Address</label>
     <textarea id="subject" name="address"  style="height:50px">${editp1.address}</textarea>

    
    
    <button type="submit" value="updateprofile" name="action">Update</button>
	</form>  
  </s:if>
</div>

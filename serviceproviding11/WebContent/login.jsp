...
<!-- <link rel="stylesheet" href="fonts/material-icon/css/material-design-iconic-font.min.css"> -->
  ...
  <script type="text/javascript">
    function validation()
    {
		...
		/* if(e_mail!=pass)
		{
			alert("invalid E_mail and Password");
					 ...
					 <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="password" name="pass" id="pincode" style="font-size: 20px;" required/>
                       ...
                       <div class="form-submit">
                            ...
                            <input type="submit" onclick="return validation();" value="Login In" class="submit" name="submit" id="submit" style="height:45px;font-size:20px;background: #ece4e4;color: #210303;"/><br><br>
                        	<a href="registration.jsp" style="font-size:20px;padding-left:10px;">Don't have an account?</a>
                        	<a href="forgotpassword.jsp" style="font-size:20px;padding-left:10px;">Forgot Password?</a>	
                        </div>

                    ...
                    <!-- <div class="service-box-layout4"> -->
                        <!-- <div class="media media-none--md"> -->
                            <!-- <div class="item-img"> -->
                               <h2>VIEW ORDER</h2>
                                <table>
                                <h4><b>Note</b> := If Service Order is Successfully Completed then Press Conform Button</h4>
                                <tr style="width:100px">
                                <th style="width:50px">Cust_Name</th>
                                ...
                                <s:forEach var="viewordersp" items="${viewordersp}">
                                <tr>
                                <td>${viewordersp.f_name}</td>
                                <td>${viewordersp.p_no}</td>
                                <td>${viewordersp.serv_subname}</td>
                                <td>${viewordersp.price}</td>
                                <td>${viewordersp.o_date}</td>
                                <td>${viewordersp.o_time}</td>
                                <td>${viewordersp.status}</td>
                                <td>${viewordersp.address}</td>
                                <td>${viewordersp.spreq_status}</td>
                                <td><a href="OrderController?action=conformorder&o_id=${viewordersp.o_id}">CONFORM</a></td>

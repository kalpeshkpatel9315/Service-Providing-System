...
<header class="header">
                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-area">
                                <a href="customerindex.jsp" class="temp-logo">
                                ...
                                <ul>
                                   <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-col-1">
                                            <li>
                                                <a href="customerplumbing.jsp"><!-- Services 1 -->Plumbing</a>
                                            </li>
                                            <li>
                                                <a href="customercleaning.jsp"><!-- Services 2 -->Cleaning</a>
                                            </li>
                                            <li>
                                                <a href="customermaid.jsp"><!-- Service Details 1 -->Maid</a>
                                            </li>
                                            <li>
                                                <a href="customerelectronics.jsp"><!-- Service Details 2 -->Electronics</a>
                                            </li>
                                            <!-- <li>
 ...
 -->                                        </ul>
                                    ...
                                    <li>
                                        <a href="customerviewprofile.jsp">View Profile</a>
                                    </li>

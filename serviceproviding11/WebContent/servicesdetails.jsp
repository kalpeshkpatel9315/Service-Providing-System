                ...
                <div class="row">
                    ...
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            ...
                            <div class="media-body space-lg">
                                <h1 class="item-title">${user1.serv_subname }</h1>
                                <h3>${user1.serv_detail}</h3>
                  ...
                  <!--   <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/windowclean1.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="windowcleaning.jsp">Window Cleaning</a></h2>
                                <p>Window cleaning is among the types of cleaning services that require work 
                                less often. You will have to work on Saturdays or Sundays only. Window cleaning,
                                 or window washing, is the exterior cleaning of architectural glass used for
                                 structural, lighting, or decorative purposes. It can be done manually, using
                                 a variety of tools for cleaning and access.
                                </p>
                                <a href="windowcleaning.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/carwash.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="carwashing.jsp">Car Washing</a></h2>
                                <p>'Waterless Car wash & detailing service. Traditionally, when you
                                 wash a car with water and sponge to get dirt loose, you are 
                                 scratching the paint. Waterless Car Wash is designed to instantly
                                 embraces dirt particles on contact causing them to break away from
                                 the surface. This allows microfiber cloth to absorb and lift all 
                                 the liquefied dirt away from the surface without scratching the 
                                 paintwork. Additionally we provide a protective layer of wax finish
                                 .Your car will have show room shine utilizing water equivalent to one cup.'</p>
                                <a href="carwashing.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div> -->

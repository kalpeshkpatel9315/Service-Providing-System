            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/babysit.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="babysitting.jsp">Baby Sitting</a></h2>
                                <p>Find & Hire Full Time Babysitters or nanny in for your child.
                                 Get in Touch with best part time baby sitters or nanny services in this website.
                                 Various options of trusted and background verified Full Time Baby Sitter. 
                                 Hire a domestic help at a click of a button.</p>
                                <a href="babysitting.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                   <!--  <div class="service-box-layout4">
                    ...
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/cook.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="cooking.jsp">Cooking</a></h2>
                                <p>Hire a Domestic Cook. ... Hiring an ideal cook is not an easy Job! the cook 
                                needsto understand your tastes, preferences & also your way of cooking meals. ... We can find you
                                 all types ofcooksas per yourrequirement - be it a Maharaj, Marathi, North Indian, South Indian, Jain, Bengali etc.
                                </p>
                                <a href="cooking.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="service-box-layout4">
                        <div class="media media-none--md">
                            <div class="item-img">
                                <img src="img/service/dishclean.jpg" alt="service">
                            </div>
                            <div class="media-body space-lg">
                                <h2 class="item-title"><a href="washdishes.jsp">Dish cleaning</a></h2>
                                <p> We do dishes too! Our maid professionals are not afraid to get their hands dirty during housekeeping. If you have a large family or party
                                 event, we can clean up for you. When getting an estimate, make sure that you tell customer service that you are in need of dishes service.
                                 This is not included in a general clean.</p>
                                <a href="washdishes.jsp" class="ghost-btn-lg text-mediumdark border-accent">See Details<i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
